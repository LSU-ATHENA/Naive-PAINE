...
from gen_dataset.datagen.prompt_loader import load_train_prompts
...
def main():
    ...
    p.add_argument('--save-dir', type=str, default='data/generated/pixart_sigma_1024')
